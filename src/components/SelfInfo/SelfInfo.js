...
function SelfInfo() {
  return (
    <section className="content__self-info">
      ...
      <div className="self-info__texts">
        <p className="self-info__text">
          <span>
            Hello! I'm a junior software engineer/web developer with a
            background in vulnerability management analysis. My passion for
            cybersecurity led me to pursue a career in IT communication. To
            expand my skills and gain a deeper understanding, I enrolled
            in&nbsp;
          </span>
          <a
          ...
          <span>
            ...
            development has become my another passion.
          </span>
        </p>
        <p className="self-info__text">
          While I continue to nurture my interest in cybersecurity, I'm excited
          to explore the world of web development as my second career. My goal
          is to make people's online experiences more secure, enjoyable, and
          convenient.
        </p>
        <p className="self-info__text">
          <span>
